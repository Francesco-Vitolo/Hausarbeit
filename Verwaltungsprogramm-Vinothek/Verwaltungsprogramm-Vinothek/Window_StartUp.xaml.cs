        ...
        private void Delete_Click(object sender, RoutedEventArgs e)
        {
            switch (location)
            {
                case "ListeProdukte":
                    ...
                    break;
                case "ListeProduzenten":
                    Produzent deleted_Prodz = ctx.Produzent.Remove((Produzent)collectionView.CurrentItem);
                    MessageBox.Show(deleted_Prodz.Name + " wurde gelöscht.");
                    break;
                case "ListeEvents":
                    Event deleted_Event = ctx.Event.Remove((Event)collectionView.CurrentItem);
